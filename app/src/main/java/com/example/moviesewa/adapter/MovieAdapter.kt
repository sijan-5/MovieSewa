...
class MovieAdapter(val onClick: (Int) -> Unit) :
    androidx.recyclerview.widget.ListAdapter<MovieData, MovieAdapter.MovieViewHolder>(
        DiffUtilCallBack()
    ) {
    ...
    class MovieViewHolder(
        private val binding: TrendingMovieRecyclerViewItemBinding,
        val context: Context
